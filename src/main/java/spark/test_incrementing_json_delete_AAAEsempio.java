...
public class test_incrementing_json_delete_AAAEsempio {
    ...
    public test_incrementing_json_delete_AAAEsempio(JavaStreamingContext jsc, Map<String, Object> params){
    ...
    public void average() throws InterruptedException {
        ...
        Collection<String> topics2 = Arrays.asList("test-incrementing-json-delete-AAAEsempio");
        ...
        stream2.foreachRDD(rdd -> {
            ...
            reducedCount.foreach(x -> System.out.println("id reduced Count: " + x));
...
//            });
            ...
            averagePair2.foreach(x -> System.out.println("id average pair: " + x));

            //print averageByKey
            averagePair2.foreach(data -> {
                System.out.println("id Key=" + data._1() + " Average=" + data._2()._1() + " Total=" + data._2()._2());
            });
